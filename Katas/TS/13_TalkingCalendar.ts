...
const talkingCalendar = (dateStr: string): string => {
...
const monthFormater = (month: string): string | boolean => {
...
const dayFormater = (day: string): string => {
	if (day === '01' || day === '21' || day === '31') return `${day}st`;
	if (day === '02' || day === '22') return `${day}nd`;
	if (day === '03' || day === '23') return `${day}nd`;
	return `${day}th`;
};
